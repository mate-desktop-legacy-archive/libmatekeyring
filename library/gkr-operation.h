...
MateKeyringResult  gkr_operation_unref_get_result  (GkrOperation *op);
...
MateKeyringResult  gkr_operation_get_result        (GkrOperation *op);
...
MateKeyringResult  gkr_operation_block_and_unref   (GkrOperation *op);
